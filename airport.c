...
void *handle_departure(void *arg) {
    ...
    // Find the runway with the minimum remaining capacity
    ...
    // Simulate boarding/loading time
    sleep(3);
    ...
    // Release the semaphore for the chosen runway
...
void *handle_arrival(void *arg) {
    ...
    // Simulate deboarding or unloading time
    sleep(3);
